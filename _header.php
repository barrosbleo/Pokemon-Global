...
<nav class="navbar navbar-default" role="navigation">
	<div class="container-fluid">
		...
		<div class="navbar-header">
		  ...
		  <a class="navbar-brand" href="/map.php?map=<?php echo base64_encode($_SESSION['player']['map_num']);?>"><div class="img"></div></a><!--https://blog.prototypr.io/making-a-jumping-box-animation-using-only-css-9b6f1635b886-->
		</div>
